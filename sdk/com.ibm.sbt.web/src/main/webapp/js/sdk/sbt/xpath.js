 ...
 * @module sbt.xpath
 */
define([ 'sbt/declare' ], function(declare) {
	/*
	...
	var XPathExpr = declare(null, {
		...
		selectSingleNode : function(xmlDomCtx) {
			...
			if (!doc.evaluate) {
				...
				var _this = this;
				if (xmlDomCtx.documentElement)
					xmlDomCtx = xmlDomCtx.documentElement;

				var result = doc.evaluate(this.xpath, xmlDomCtx, function(
						prefix) {
